...
function ListCustomers() {
    const headers = ['ID', 'Nombre', 'ApellidoPaterno', 'ApellidoMaterno', 'Editar', 'Eliminar'];
 ...
 // Simulando la carga de datos de una API
    useEffect(() => {
        ...
        const fetchData = async () => {
            const response = [
                { id: 1, nombre: 'Jhovany', apellidoPaterno: 'Flores', apellidoMaterno: 'Lozano',}
                        ...
                        <form onSubmit={handleEditSubmit} className="mt-2 text-left">
                            ...
                            <div className="mb-4">
                                ...
                                <InputForm 
                                    ...
                                    placeholder="Ingrese el nuevo Apellido Materno del cliente"
